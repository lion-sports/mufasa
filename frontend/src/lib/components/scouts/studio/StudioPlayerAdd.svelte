	...
	<div class="mt-4 max-h-[80vh] overflow-auto">
		{#if selectedTab == 'importConvocation'}
			<div class="grid grid-cols-2 gap-2 items-center">
				<div class="mb-2">
					<LabelAndCheckbox label="Importa maglie" id="import-shirt" bind:value={importShirtsActive}
					></LabelAndCheckbox>
				</div>
				<div class="mb-2">
					<LabelAndCheckbox label="Importa ruoli" id="import-roles" bind:value={importRolesActive}
					></LabelAndCheckbox>
				</div>
				<div class="mb-2">
					<LabelAndCheckbox
			...
			<div class="mb-2 w-full">
				<StandardButton on:click={importAllTeammates} --button-width="100%"
					...
					>
						...
						<div class="ml-auto">
							{#if loadingImportConvocation == convocation.id}
								<CircularLoader --circular-loader-width="12px" --circular-loader-height="12px"
								></CircularLoader>
		...
		{:else if selectedTab == 'create'}
			...
			<div class="mt-4">
				<StandardButton on:click={createPlayer} --button-width="100%">Crea</StandardButton>
			</div>
		{/if}
	</div>
</div>
