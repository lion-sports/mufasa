<script lang="ts">
	...
	function triggerEvent<Category extends keyof EventToResultType>(
		category: Category,
		event: EventToResultType[Category]
	) {
	...
	function showToast<Category extends keyof EventToResultType>(
		category: Category,
		event: EventToResultType[Category]
	) {
...
>
	<div class="flex flex-col gap-1 @4xl:hidden">
		<button
			...
			onclick={() => toggleCategory('serve')}>Battuta</button
		>
		<button
			class="category-button text-left p-3 rounded-md w-full hover:bg-[var(--hover-background-color)] bg-[var(--background-color)] text-lg font-medium"
			class:selected={selectedCategory == 'receive'}
			onclick={() => toggleCategory('receive')}>Ricezione</button
		>
		<button
			class="category-button text-left p-3 rounded-md w-full hover:bg-[var(--hover-background-color)] bg-[var(--background-color)] text-lg font-medium"
			class:selected={selectedCategory == 'spike'}
			onclick={() => toggleCategory('spike')}>Attacco</button
		>
		<button
			class="category-button text-left p-3 rounded-md w-full hover:bg-[var(--hover-background-color)] bg-[var(--background-color)] text-lg font-medium"
			class:selected={selectedCategory == 'block'}
			onclick={() => toggleCategory('block')}>Muro</button
		>
	</div>
	<div class="flex flex-col gap-2 @4xl:hidden">
		{#if selectedCategory == 'serve'}
			<StudioPlayerActionButton
				...
				onclick={() => triggerEvent('serve', 'error')}>Errore</StudioPlayerActionButton
			>
			<StudioPlayerActionButton
				icon="mdi-minus"
				progress={50}
				...
				onclick={() => triggerEvent('serve', 'received')}>Ricevuta</StudioPlayerActionButton
			>
			<StudioPlayerActionButton
				icon="mdi-check"
				progress={100}
				...
				onclick={() => triggerEvent('serve', 'point')}>Punto</StudioPlayerActionButton
			>
		{:else if selectedCategory == 'spike'}
			<StudioPlayerActionButton
				...
				--icon-color="#ef444470"
				--circular-progress-indicator-color="#ef444470"
				onclick={() => triggerEvent('spike', 'error')}>Errore</StudioPlayerActionButton
			>
			<StudioPlayerActionButton
				icon="mdi-minus"
				progress={50}
				--icon-color="#f59e0b70"
				--circular-progress-indicator-color="#f59e0b70"
				onclick={() => triggerEvent('spike', 'defense')}>Difeso</StudioPlayerActionButton
			>
			<StudioPlayerActionButton
				icon="mdi-check"
				progress={100}
				--icon-color="#22c55e70"
				--circular-progress-indicator-color="#22c55e70"
				onclick={() => triggerEvent('spike', 'point')}>Punto</StudioPlayerActionButton
			>
		{:else if selectedCategory == 'block'}
			<StudioPlayerActionButton
				icon="mdi-close"
				onclick={() => triggerEvent('block', 'handsOut')}
				progress={25}
				--icon-color="#ef444470"
				--circular-progress-indicator-color="#ef444470">Mani out</StudioPlayerActionButton
			>
			<StudioPlayerActionButton
				onclick={() => triggerEvent('block', 'touch')}
				icon="mdi-hand-back-left"
				progress={50}
				--icon-color="#f9731670"
				--circular-progress-indicator-color="#f9731670">Tocco</StudioPlayerActionButton
			>
			<StudioPlayerActionButton
				onclick={() => triggerEvent('block', 'putBack')}
				icon="mdi-redo"
				progress={75}
				--icon-color="#f59e0b70"
				--circular-progress-indicator-color="#f59e0b70">Tocco e ritorno</StudioPlayerActionButton
			>
			<StudioPlayerActionButton
				onclick={() => triggerEvent('block', 'point')}
				icon="mdi-plus"
				progress={100}
				--icon-color="#22c55e70"
				--circular-progress-indicator-color="#22c55e70">Punto</StudioPlayerActionButton
			>
		{:else if selectedCategory == 'receive'}
			<StudioPlayerActionButton
				...
				--icon-color="#ef444470"
				--circular-progress-indicator-color="#ef444470"
				onclick={() => triggerEvent('receive', 'x')}>Errore</StudioPlayerActionButton
			>
			<StudioPlayerActionButton
				...
				onclick={() => triggerEvent('receive', '/')}>Slash</StudioPlayerActionButton
			>
			<StudioPlayerActionButton
				icon="mdi-minus"
				progress={60}
				--icon-color="#f59e0b70"
				--circular-progress-indicator-color="#f59e0b70"
				onclick={() => triggerEvent('receive', '-')}>Meno</StudioPlayerActionButton
			>
			<StudioPlayerActionButton
				icon="mdi-plus"
				progress={80}
				--icon-color="#22c55e70"
				--circular-progress-indicator-color="#22c55e70"
				onclick={() => triggerEvent('receive', '+')}>Più</StudioPlayerActionButton
			>
			<StudioPlayerActionButton
				icon="mdi-plus-thick"
				progress={100}
				--icon-color="#22c55e70"
				--circular-progress-indicator-color="#22c55e70"
				onclick={() => triggerEvent('receive', '++')}>Perfetta</StudioPlayerActionButton
			>
		{/if}
	</div>
			...
			<div>
				...
				<div class="grid grid-cols-1 @5xl:grid-cols-2">
					<StudioPlayerActionButton
						...
						--icon-color="#ef444470"
						--circular-progress-indicator-color="#ef444470"
						onclick={() => triggerEvent('block', 'handsOut')}>Mani out</StudioPlayerActionButton
					>
					<StudioPlayerActionButton
						icon="mdi-hand-back-left"
						progress={50}
						--icon-color="#f9731670"
						--circular-progress-indicator-color="#f9731670"
						onclick={() => triggerEvent('block', 'touch')}>Tocco</StudioPlayerActionButton
					>
					<StudioPlayerActionButton
						icon="mdi-redo"
						progress={75}
					...
					<StudioPlayerActionButton
						...
						--icon-color="#22c55e70"
						--circular-progress-indicator-color="#22c55e70"
						onclick={() => triggerEvent('block', 'point')}>Punto</StudioPlayerActionButton
					>
				</div>
			</div>
		</div>
	...
	<div class="hidden @4xl:block">
		<div class="flex flex-col gap-2">
			...
			<div>
				<div class="flex justify-center items-center w-full">
					<div class="subheading relative text-center font-light text-sm mb-1 ml-2 mt-1">
						Attacco
					</div>
				</div>
				<div class="grid grid-cols-1 @5xl:grid-cols-2">
