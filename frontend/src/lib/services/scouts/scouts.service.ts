...
export const ROLES = [...VOLLEYBALL_ROLES, ...BASKETBALL_ROLES]
...
export default class ScoutsService extends FetchBasedService {
	...
	public async updateSetting(params: { id: number; settings: ScoutInfoSettings }): Promise<Scout> {
		return await this.update({
			id: params.id,
			scoutInfo: {
	...
	public async exportXlsx(params: { id: number }): Promise<void> {
	...
	public static get friendsColors() {
		return ['#3b82f6', '#1354bf', '#4481e5', '#224a8d', '#5d8ad6', '#123a7e']
	}
	...
	public static get opponentsColors() {
		return ['#ef4444', '#cb0f0f', '#fc1d1d', '#9d1010', '#952b2b', '#963d3d']
	}
