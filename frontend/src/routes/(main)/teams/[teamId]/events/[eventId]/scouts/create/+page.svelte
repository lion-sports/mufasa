<script lang="ts">
	...
	let valid = $derived(
		!!scout.eventId && !!scout.sport && !!scout.startedAt && !!scout.scoringSystemId
	)
</script>

<PageTitle title="Nuovo scout" subtitle={data.event.name} prependVisible></PageTitle>

<ScoutForm bind:scout></ScoutForm>
